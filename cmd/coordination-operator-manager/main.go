...
import (
	...
	coordinationapis "github.com/ensure-stack/coordination-operator/apis"
	"github.com/ensure-stack/coordination-operator/internal/controllers"
)
...
func main() {
	...
	if err = (&controllers.HandoverReconciler{
	...
	if err = (&controllers.ClusterHandoverReconciler{
		Client:          mgr.GetClient(),
		DynamicClient:   dynamicClient,
		DiscoveryClient: discoveryClient,
	...
	if err = (&controllers.ClusterAdoptionReconciler{
		Client:          mgr.GetClient(),
		DynamicClient:   dynamicClient,
		DiscoveryClient: discoveryClient,
