...
func (s *ClusterHandoverStatus) UpdatePhase() {
	...
	if completedCond != nil {
		...
		case metav1.ConditionTrue:
			s.Phase = ClusterHandoverPhaseCompleted
			return
		case metav1.ConditionFalse:
			s.Phase = ClusterHandoverPhaseProgressing
			return
		}
	}

	s.Phase = ClusterHandoverPhasePending
}
